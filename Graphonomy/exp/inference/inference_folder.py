...
if __name__ == '__main__':
    ...
    parser.add_argument('--imgfolder_path', default='', type=str)
    ...
    for imgfolder in tqdm(os.listdir(opts.imgfolder_path)):
        imgfolderInt = int(imgfolder)
        if opts.min<=imgfolderInt < opts.max:
